...
Version: v0.20.0
Changelog:
- v0.20.0: 공용 fixture 계획서 완료 후 `Documents/Plan/Archive/v2/ADump_FixturePlan.md` 로 아카이브한 상태를 반영.
- v0.19.0: 공용 fixture 계획서를 v2 아카이브 밖의 별도 계획서로 정정.
...
7. 공용 fixture 생성/검증 보강은 완료 후 `Documents/Plan/Archive/v2/ADump_FixturePlan.md` 로 아카이브했다.
...
3. 외부 UE 프로젝트가 생기면 `ValidationProfile=plugin` 단독 검증을 별도 확인한다.
...
- 사실:
  ...
  - 공용 fixture 보강 계획 `Documents/Plan/Archive/v2/ADump_FixturePlan.md` 완료 아카이브 확인
...
공용 fixture 생성/검증 보강 작업은 v2 문서 마감과 분리했고, 완료 후 아래 문서로 아카이브했다.
