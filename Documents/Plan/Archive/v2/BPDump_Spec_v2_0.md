...
Version: v2.2.0
Changelog:
- v2.2.0: 기본 출력 루트를 Project Saved에서 `UE/Plugins/ue-assetdump/Dumped` 기준으로 갱신.
  ...
  "assets": [
    {
      ...
      "generated_time": "2026-03-27T11:00:00Z",
      "fingerprint": "....",
      "manifest_path": "UE/Plugins/ue-assetdump/Dumped/BPDump/Game_UI_WBP_MainMenu/manifest.json",
      "digest_path": "UE/Plugins/ue-assetdump/Dumped/BPDump/Game_UI_WBP_MainMenu/digest.json"
    }
  ]
}
```
