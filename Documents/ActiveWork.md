...
```text
active lifecycle: ADUMP-v1.4.0-PUC / Completed / PU-G6 PASS / Full Public Usability Accepted
...
PUC-6 Result: Documents/Plan/PublicUsabilityPUC6Result.md v1.0 / PU-G6 PASS
...
capabilities: 35 / PUBLIC_READY 29 / NATIVE_ONLY_BY_DESIGN 6 / IMPLEMENTED_BUT_UNMAPPED 0 / unclassified 0
PU-G0: PASS
PU-G1: PASS
PU-G2: PASS / R5 Browser exact-nine actual accepted
PU-G3: PASS / Browser actual accepted / CORR1 PASS
PU-G4: PASS / J1-J8 / public 29/29 / native-only 6/6 / unmapped 0
PU-G5: PASS / real-project 5/5 / RP5 preserved / mutation 0 / operational 4/4 / owner environment
PU-G6: PASS / terminal trust matrix / 115 regression PASS
AssetDump Product Source correction: COMPLETE / ADumpService.cpp v0.15.1
...
PUC-2 contract: Documents/Plan/PublicUsabilityPUC2Prep.md v1.2 / historical preparation
PUC-2 retrieval target: summary,digest,details,data_asset_values,input_summary,component_tree,bp_search_index,references,widget_designer
PUC-2 architecture: GoPyMCP read-only asset_index_v1 + section_index_v1 source resolution
GoPyMCP Codex task: Workspace/docs/operations/Codex_ADump_PUC2.md v1.0.0 / Ready
PUC-2 GoPyMCP implementation: Local Complete / 118 focused passed
...
exact-nine Product actual: two fresh runs / 4 succeeded / 0 failed / normalized mismatch 0
canonical Phase 2: PASS / failure_count=0
R4 actual: /Game/Test batch 4/4 + discover 4/4 / six sections available / three representative sections absent
R4 classification: BLOCKED_FIXTURE_ROOT_COVERAGE / missing+bounds+determinism not run
R5 actual: 17/17 batch + 17/17 discover / exact-nine coverage + missing + bounds + repeat determinism PASS
Browser handoff: Documents/Plan/PUC2BrowserHandoff.md v1.2 / Completed
PUC-3 preparation: Documents/Plan/PublicUsabilityPUC3Prep.md v1.1 / PU-G3 CORR1 PASS
GoPyMCP PUC-3 Result: Workspace/docs/plan/PUC3_Specialized_Result.md v1.2.0 / Browser PU-G3 Accepted / CORR1 PASS
Browser handoff: Workspace/docs/plan/PUC3_Browser_Handoff.md v1.2.0 / Historical Completed
PUC-3 correction: Workspace/docs/operations/Codex_ADump_PUC3_Corr1.md v1.1.0 / Completed
CORR1 Browser handoff: Workspace/docs/plan/PUC3_Corr1_Handoff.md v1.0.0 / Not Required / Optional Audit
PUC-4 preparation: Documents/Plan/PublicUsabilityPUC4Prep.md v1.11 / Completed
PUC-4 Browser handoff: Workspace/docs/plan/PUC4_Browser_Handoff.md v1.13.0 / Historical Completed
PUC-4 Result: Documents/Plan/PublicUsabilityPUC4Result.md v1.0 / PU-G4 PASS
GoPyMCP PUC-4 Result: Workspace/docs/plan/PUC4_Golden_Result.md v1.0.0 / PASS
R1 boundary: stale six-operation Browser schema / actual 0 / local exact-eight and public upstream PASS
R2 boundary: schema PASS / J1 batch+discover PASS / include flags omitted / section stop
R3 boundary: fresh J1 batch/discover PASS / asset_sections real-sidecar parse stop
R3 correction: GoPyMCP transport path projection + HTTPS false positive / 113 tests + actual six sections + restarted live schema PASS
R4 boundary: J1 batch/discover + sections repeat PASS / EventGraph graph-get input stop
R5 boundary: query_operation=get included / graph closed ownership stop
R6 boundary: exact input accepted / duplicate-GUID detail hydration stop
R6 correction: GUID+class composite / 114 tests + real full route PASS / Adapter restarted
R7C actual: graph 2/2 / shape+determinism PASS / leakage 0
R8 actual: J1-J3 completed / public 16/29 / bounds+determinism PASS / J4 retryable internal prepare stop
R9 actual/diagnosis: J4 repeated / IA+IMC 2 success + unsupported 15 failed_save / explicit mixed-root selection error
R10 actual: J4 PASS / total 18/29 / J5 entity_context closed-input stop
R11 actual: J5-J7 PASS / total 25/29 / J8 pre-execution orchestration budget stop
R12 actual: J8 batch PASS / discover omitted root default / managed cross-selection stop
R13 local proof: exact sequence 1 PASS / related integration+compatibility 115 PASS
R13 Browser actual: J8 PASS / public 29/29 / native-only 6/6 / unmapped 0
PUC-5 exact representative matrix: BP_CFVehiclePawn / DA_FX_ProtoVehicleDead / IA_Throttle+IMC_Vehicle_Default / WBP_TargetSelect / preserved NS_AOE_Explosion_1
PUC-5 local contract proof: PASS / current exact-eight+exact-nine / R13 exact-six+exact-seven shapes / Product/schema delta 0
PUC-5 R1: schema 1 / git.diff 0 / batch 1 / baseline precondition invalid / RP actual 0
PUC-5 R2 correction: baseline-before-batch hard sequence / accepted 8100 listener noise=environment / unsupported nonzero fail-closed
PUC-5 R2: baseline acquired / RP1 accepted output return_code 1 / public diagnostics projection stop
PUC-5 R2 local RCA: exact listener bind + fresh report + commandlet result 0 / owner environment
PUC-5 R3: RP1 PASS / RP2 batch success + data_asset_values not generated / Product defect false
PUC-5 local correction proof: RP2 3/3 + values / RP3 15/15 + input / RP4 21/21 + widget / public retrieval PASS
PUC-5 R6 terminal: real-project 5/5 / mutation 0 / operational 4/4 / safety zeros
Full Public Usability Accepted: true
next action: none / follow-up changes require a new lifecycle
```

## v3.50 Changelog / Migration

- terminal trust matrix와 current 115 PASS를 통합해 PU-G6 PASS로 닫았다.
- ADUMP-v1.4.0-PUC를 Full Public Usability Accepted로 전환했다.

Migration: 기존 PUC actual을 반복하지 않는다. 후속 변경은 새 lifecycle에서 시작한다.

## v3.49 Changelog / Migration

- R6 terminal actual을 통합해 PUC-5 Complete / PU-G5 PASS로 닫았다.
- `PublicUsabilityPUC5Result.md` v1.0을 authoritative Result로 등록하고 PUC-6 Ready로 전환했다.

Migration: PUC-5 actual을 반복하지 않는다. PU-G6 전까지 Full Public Usability Accepted는 false다.

## v3.45 Changelog / Migration

- PUC-5 representative real-project matrix와 operational ownership 범위를 동결했다.
- `PublicUsabilityPUC5Prep.md` v1.0의 local exact contract proof를 PASS로 등록하고 Browser R1 Ready로 전환했다.
- PUC-4 J1-J8 및 real Niagara RP5는 반복하지 않는 보존 증거로 고정했다.

Migration: Product Source/Content/CarFight asset 변경 없이 PUC-5 Browser R1 RP1-RP4만 fresh 실행한다. PU-G5는 actual 전까지 PASS가 아니다.

## v3.44 Changelog / Migration

- R13 terminal actual과 local proof를 통합해 PUC-4 Complete / PU-G4 PASS로 닫았다.
- 다음 Gate를 PUC-5로 전환하고 Full Public Usability는 false로 유지했다.

Migration: PUC-4 actual을 반복하지 않는다. PUC-5는 별도 scope 준비 후 시작한다.

## v3.43 Changelog / Migration

- R13 exact J8 sequence handler regression과 관련 integration/compatibility 115 PASS를 기록했다.

Migration: Browser에는 local-proven v1.12.1 exact input만 전달한다. Product/asset 변경은 없다.

## v3.42 Changelog / Migration

- R12 J8 discover stop을 omitted root default `/Game`과 immutable dataset root 불일치로 확정했다.
- R13 discover exact allowlist에 matching root를 추가했다.

Migration: R8-R12 ref는 재사용하지 않는다. Product/Adapter/runtime/asset 변경 없이 fresh J8만 실행한다.

## v3.41 Changelog / Migration

- R11 J5-J7 PASS와 25/29를 통합하고 J8 budget stop을 pre-execution 경계로 분리했다.
- R12 J8-only exact contract 뒤 terminal closure 문서를 한 번 동기화한다.

Migration: R8-R11 ref는 재사용하지 않는다. Product/Adapter/runtime/asset 변경 없이 fresh J8만 실행한다.

## v3.40 Changelog / Migration

- R10 J4 PASS와 누적 18/29를 통합하고 J5 context 실패를 operation ownership 입력 오류로 분류했다.
- R11에 entity_context/context_bundle exact six-field allowlist를 등록했다.

Migration: R8-R10 ref를 재사용하지 않는다. Product/Adapter/runtime/asset 변경 없이 fresh J5부터 실행한다.

## v3.39 Changelog / Migration

- R9과 local run_report로 J4 실패를 Product defect가 아닌 mixed-root explicit section selection 오류로 확정했다.
- J4 preparation만 full mode로 교정한 R10을 등록했다.

Migration: R8/R9 ref를 재사용하지 않는다. Product/Adapter/runtime/asset 변경 없이 fresh J4부터 실행한다.

## v3.38 Changelog / Migration

- R8 J1-J3 16/29와 bounds/determinism PASS를 보존하고 J4 retryable preparation failure를 기록했다.
- R9을 J4-J8 독립 재개로 제한해 이미 통과한 journey 반복을 제거했다.

Migration: R8 ref는 호출에 재사용하지 않는다. 같은 J4 failure 반복 시 local 진단으로 전환한다.

## v3.37 Changelog / Migration

- R7C Browser graph canary PASS를 Current에 통합하고 graph blocker를 닫았다.
- 추가 canary 없이 R8 full J1-J8 matrix로 복귀했다.

Migration: R7C ref를 재사용하지 않고 R8을 J1부터 journey별 fresh 실행한다.

## v3.36 Changelog / Migration

- R6 graph hydration stop과 GoPyMCP composite identity correction closure를 Current에 등록했다.
- Product Source/Content/CarFight asset delta 0을 유지하며 R7 handoff로 전환했다.

Migration: R6 dataset/ref를 재사용하지 않고 R7을 J1부터 fresh 실행한다.

## v3.35 Changelog / Migration

- R5 graph ownership stop과 exact graph accepted/non-owned field rejected local reproduction을 Current에 등록했다.
- R6는 graph-only exact arg allowlist를 사용하며 Product/Adapter/runtime/asset delta 0이다.

Migration: R5 dataset/ref를 재사용하지 않고 R6를 J1부터 fresh 실행한다.

## v3.34 Changelog / Migration

- R4 section bounds/determinism PASS와 graph-get 입력 stop을 Current에 기록하고 R5 exact fields를 등록했다.
- Product/Adapter/runtime/asset delta 0을 유지했다.

Migration: R4 dataset/ref를 재사용하지 않고 R5를 J1부터 fresh 실행한다.

## v3.33 Changelog / Migration

- R3 parse stop을 Product가 아닌 GoPyMCP public projection 결함으로 분류하고 local correction closure를 등록했다.
- Product Source/Content/CarFight asset delta 0을 유지하며 R4 handoff를 Current로 전환했다.

Migration: R3 dataset/ref를 재사용하지 않고 R4를 J1부터 fresh 실행한다.

## v3.32 Changelog / Migration

- R2 first-failure를 Product가 아닌 handoff generation flag 누락으로 분류했다.
- affected J1/J2/J3/J8 flag를 교정한 R3 handoff를 Current에 등록했다.

Migration: R2 dataset/ref를 재사용하지 않고 R3를 J1부터 실행한다. Product/runtime/asset은 변경하지 않는다.

## v3.31 Changelog / Migration

- R1 stale schema stop과 actual 0을 Current에 기록하고 local/public publication 정상 근거를 분리했다.
- Product/code/runtime 변경 없이 Browser Action refresh 후 R2로 전환했다.

Migration: runtime을 재시작하거나 R1을 retry하지 않는다. 새 Browser Action snapshot에서 R2를 실행한다.

## v3.30 Changelog / Migration

- PUC-4 J1~J8 golden journey, PUBLIC_READY 29/29 계획 coverage와 native-only 6/6 classification check를 Current에 등록했다.
- Browser R1 exact handoff와 Product Source/Content/CarFight asset delta 0 경계를 연결했다.

Migration: PU-G1/2/3 historical ref를 재사용하지 않는다. Browser R1 report 전에는 PU-G4 PASS로 전환하지 않는다.

## v3.29 Changelog / Migration

- CORR1 C1/C2 local correction과 C3 option B, focused 168 PASS를 Current에 반영했다.
- matrix를 29/6/0으로 재분류하고 PUC-4를 Ready로 전환했다.

Migration: historical PU-G3 actual과 CORR1 optional audit은 반복하지 않는다. Product Source/Content/CarFight asset은 변경하지 않는다.

## v3.28 Changelog / Migration

- PU-G3 Browser Acceptance를 보존하면서 PUC-4 전 중간검토 correction 3건을 `ADUMP-v1.4.0-PUC-PUC3-CORR1`로 등록했다.
- truncated Diff baseline, Diff max_bytes, generic Context coverage를 Codex 좁은 correction으로 이관하고 PUC-4를 차단했다.
- matrix 20/6/9는 CORR1 closure 전까지 임시 유지하며 29/6/0을 미리 확정하지 않는다.

Migration: PUC-3 actual을 전체 반복하지 않는다. Codex correction 후 필요한 최소 Browser actual만 새 handoff로 수행한다.

## v3.27 Changelog / Migration

- GoPyMCP PUC-3 opaque Diff/Context local implementation과 focused 155 PASS를 Current에 연결했다.
- Product Source/Content/CarFight asset delta 0을 유지하고 Browser PU-G3 R1을 next Gate로 전환했다.

Migration: matrix 20/6/9와 Full Public Usability false는 Browser actual 전까지 유지한다. PUC-2는 재실행하지 않는다.

## v3.26 Changelog / Migration

- R5 Browser actual의 17/17 fresh dataset, exact-nine coverage, missing isolation, bounds와 repeat determinism을 승인했다.
- PUC-2를 `PU-G2 PASS`로 닫고 matrix를 20 ready / 6 native-only / 9 unmapped로 갱신했다.
- 다음 Current 작업을 PUC-3 specialized capability closure로 전환했다.

Migration: PUC-2 actual은 반복하지 않는다. R3/R4는 historical evidence이며 Full Public Usability Accepted는 계속 false다.

## v3.25 Changelog / Migration

- R4 schema, Product batch 4/4와 discover 4/4 PASS를 통합했다.
- `/Game/Test`의 DataAsset/Input/Widget representative 부재를 Product defect가 아닌 fixture-root coverage blocker로 분류했다.
- accepted Plugin fixtures `/AssetDump/Validation`을 사용하는 R5 handoff로 전환했다.

Migration: CarFight 에셋은 추가하지 않는다. R4 미실행 missing/bounds/determinism은 R5에서 fresh 검증한다.

## v3.24 Changelog / Migration

- exact-nine batchdump 4/4 `failed_save`를 다중 요청의 unsupported 조기 종료 defect로 진단하고 `ADumpService.cpp` v0.15.1로 복구했다.
- `/Game/Test` fresh actual 두 회 4/4, normalized JSON mismatch 0, strict single unsupported regression PASS를 기록했다.
- clean BuildPlugin, 공식 CarFight Editor build와 canonical Phase 2 failure_count 0을 통과했다.
- `PUC2RepairResult.md`와 Browser R4 handoff를 등록하고 PU-G2를 rerun ready로 전환했다.

Migration: Product readiness는 복구됐지만 Browser actual 전에는 PU-G2 PASS로 승격하지 않는다. 기존 R3 실패는 historical evidence로 보존한다.

## v3.23 Changelog / Migration

- PUC-2 preparation audit으로 existing public reader의 main-dump-only limitation과 AssetDump section-index reusable contract를 확인했다.
- exact public retrieval 9개와 index-backed source/pointer, no-path-leakage, no-support-inference contract를 동결했다.
- GoPyMCP Codex task card를 Ready로 등록하고 Product Source correction required=false를 유지했다.

Migration: PUC-1 actual은 반복하지 않는다. PUC-2 implementation과 PU-G2 Browser actual은 아직 PASS로 주장하지 않는다.
...
```text
active lifecycle: ADUMP-v1.2.0-AIRE / Completed / Consumer Accepted
active task: ADUMP-v1.2.0-AIRE-G6 / Completed / AIRE_G6_PASS
...
Product release correction: AssetDumpCommandlet.cpp v0.24.2 / case-sensitive asset_index_v1 + section_index_v1 ordering
Phase 2 release verification: PASS / report SHA-256 66a07acef3abd7f1d8a73dc551adb719043f9fa991b3f3ff64530cf448562c13
Phase 1 Matrix: PASS / failure_count=0 / report SHA-256 24617984bedb885a0bc411ffb01d4d79117e56fe7ff0f3e0949e51b7158ec205
fresh real-project probe: P5_MI_V1_PROBE_PASS / Deep 18/12 / Material 19/12 / MI 4/4 / overrides 11
fresh real-project report SHA-256: 0f4a2251968365622265eee7c6b34d526089e5548c991d654dcc528ad490f15e
fresh public Consumer revalidation: PASS / same real-project explicit provider chain / AIREG6ConsumerReval.json SHA-256 cbf4721418650530b6441c0a24f40b197f4ad39c1858d17f15e86031515d2720
exact 17 Content: PASS / unchanged
CarFight real asset: unchanged
AIRE-G6: PASS
next decision: AIRE release lifecycle closed; future feature work requires a new explicit lifecycle/Plan
```

## v3.13 Changelog / Migration

- current v0.24.2 package로 동일 real-project explicit provider를 fresh 준비해 RP12/12, native lifecycle 12/12와 public `discover -> entity_query -> entity_context -> dependency_query` chain을 모두 PASS했다.
- `RunAIREP5Verify.ps1 v0.3.4` runner finalization correction과 fresh read-only UE Registry RP07 evidence를 반영했으며 Product Source와 exact 17 Content는 변경하지 않았다.
- `AIREG6ConsumerReval.json`을 stronger explicit-provider evidence로 갱신하고 `AIREG6Result.md` v1.2에 연결했다.
- historical G5와 기존 accepted Phase 4/5 evidence는 재분류하지 않는다.

## v3.12 Changelog / Migration
...
- `Documents/Plan/AIREG6ConsumerReval.json`을 machine-readable Consumer revalidation evidence로 추가하고 `AIREG6Result.md` v1.1에 연결했다.
- current lifecycle/state routing의 stale Phase 4/G6 미착수 문구를 terminal `Completed / Consumer Accepted / AIRE-G6 PASS`에 맞춰 교정했다.
- historical AIRE-G5 `FAILED_REAL_PROJECT_EVIDENCE`와 Phase 4/5 historical snapshots은 재분류하지 않으며 Product/Script/Content/Config 변경은 없다.

## v3.11 Changelog / Migration

- G6 fresh release validation에서 `asset_index_v1`과 `section_index_v1`의 case-sensitive deterministic ordering 구현 결함을 발견해 `AssetDumpCommandlet.cpp v0.24.2`로 교정했다.
- Phase 2 runner의 stale exact-12 P2-N4 baseline을 current exact-17로 동기화하고 final Phase 2, Phase 1 Matrix와 fresh real-project probe를 모두 PASS로 닫았다.
- AIRE-G6를 `PASS`, Phase 6을 `Completed / Accepted`, 전체 `ADUMP-v1.2.0-AIRE`를 `Completed / Consumer Accepted`로 전환했다.
- historical AIRE-G5 `FAILED_REAL_PROJECT_EVIDENCE`는 재분류하지 않으며 public schema/data migration은 없다.



## Historical P5-N0 Result Override — 2026-08-07

```text
active task: ADUMP-v1.2.0-AIRE-P5-N0 / Completed / P5_N0_GO_PUBLIC_API
representative Plan: Documents/Plan/AIREPhase5Plan_v1.md v1.1
P5-N0 Result: Documents/Plan/AIREP5N0Result.md v1.0
AIRE-G5: historical FAILED_REAL_PROJECT_EVIDENCE / unchanged
P4-N4: P4_N4_PASS / exact 17 protected
P5-N1 Product Source: Not Authorized / Authorization Review Candidate
P5-N2+: Not Authorized
AIRE-G6: Not Authorized
next decision: authorize P5-N1 exact 8-file Product Source implementation or keep Phase 5 implementation closed
```

## v3.10 Changelog / Migration

- P5-N0~N4, P5-ID-GATE와 P5-MI v1 validation closure의 authoritative PASS evidence를 반영해 Phase 5를 `Completed / Accepted`로 닫았다.
- P5-MI real-project 4/4 detail facet, 11 direct overrides, static-switch positive case와 post-MI F01-F24 24/24를 closure evidence로 등록했다.
- historical AIRE-G5 `FAILED_REAL_PROJECT_EVIDENCE`는 재분류하지 않고, Phase 5가 해당 renderer resource/MI gap을 후속 evidence로 해결한 사실만 기록했다.
- AIRE-G6는 `Not Started / Not Authorized`로 유지했고 build/commandlet/provider 검증을 재실행하지 않았다.

## v3.9 Changelog / Migration

- P5-N0 read-only UE 5.8 Renderer Resource API spike를 `P5_N0_GO_PUBLIC_API`로 완료했다.
- Sprite/Ribbon direct Material, Mesh `GetUsedMeshes`와 explicit material override typed path를 확정했다.
- user-bound/transient/StaticMesh-owned default materials는 fail-closed exclusion으로 고정했다.
- Product Source는 수정하지 않았고 P5-N1을 Authorization Review Candidate로만 전환했다.

## Historical Phase 5 Planning Override — 2026-08-07

```text
active feature lifecycle: ADUMP-v1.2.0-AIRE / Phase 5 Material Evidence Adapter Planning Complete
active feature task: ADUMP-v1.2.0-AIRE-P5 / Planning Complete / Product Not Authorized
representative current Plan: Documents/Plan/AIREPhase5Plan_v1.md v1.0
historical G5 result: Documents/Plan/AIResourceEvidenceG5Result.md v1.0 / FAILED_REAL_PROJECT_EVIDENCE / unchanged
Phase 4 terminal: P4_N4_PASS / exact 17 Content protected
Phase 5 Product implementation: Not Authorized
Phase 5 validation execution: Not Authorized
AIRE-G6: Not Authorized
next decision: P5-N0 UE 5.8 Renderer Resource API spike authorization review; Product Source remains separately gated
```

이 override가 아래의 `Phase 5 Planning Candidate` 및 G5를 representative current Plan으로 표시한 과거 lifecycle 문구보다 우선한다. G5는 historical actual로 유지하며 단순 재실행하지 않는다.

## v3.8 Changelog / Migration

- `AIREPhase5Plan_v1.md` v1.0을 Phase 5 대표 planning contract로 등록했다.
- 별도 `niagara_material_evidence` / `niagara_material_v1` 후보와 additive 19 Entity / 12 Relation 전략을 고정했다.
- `niagara_renderer_resource` typed Entity와 기존 `references` Relation으로 Renderer-owned Material/MI/Mesh Evidence chain을 설계했다.
- dependency query bridge, typed bounded resource access, exact 24 fixture + 12 real-project matrix와 12 native / 20 provider lifecycle robustness matrix를 등록했다.
- Phase 4 18/12, P4-N4, exact 17, G5 historical result를 보호하고 Product implementation과 G6는 Not Authorized로 유지했다.

## v3.7 Changelog / Migration

- actual CarFight `NS_AOE_Explosion_1` G5 Consumer validation을 수행했다.
- 9,103 Entity, 11 Emitter, 11 Renderer, execution topology와 large bounded Context는 PASS했다.
- UE Registry가 보유한 Material/Material Instance와 Mesh dependency를 public AssetDump Evidence ID/relation/dependency edge로 연결하지 못해 G5-C가 실패했다.
- `asset_reference` continuation 중 한 건의 provider-process robustness issue를 기록했다.
- 외부 GoPyMCP COV-06C 동시 변경 1건으로 G5-F protection도 실패했다.
- primary classification을 `FAILED_REAL_PROJECT_EVIDENCE`, Phase 5를 Planning Candidate / Not Authorized로 전환했다.

## v3.6 Changelog / Migration

- P4-N4를 Closed/PASS로 동결하고 AIRE-G5 Real Project Acceptance를 사용자 승인에 따라 활성화했다.
- CarFight `DA_FX_ProtoVehicleDead`가 실제 참조하는 `NS_AOE_Explosion_1`을 G5 대상 asset으로 선정했다.
- 대상은 6개 Niagara Emitter와 다수 Material/Mesh dependency를 가진 real-project FX다.
- G5는 validation-only이며 AssetDump Product/Script/Content/Config, CarFight, GoPyMCP Source/schema/config 수정은 금지한다.
- 대표 Plan을 `AIResourceEvidenceG5Plan.md` v1.0으로 등록했다.

## v3.5 Changelog / Migration

- COV 작업 중단 후 AssetDump·GoPyMCP와 지정 COV 3개 파일의 동일 기준선을 두 번 확인해 quiescent window를 확정했다.
- fresh r4 B/C/D registrations와 28 public calls로 revised exact 40 전체를 실행했다.
- Group A 8/8, B 16/16, C 8/8, D 8/8과 protected mismatch 0을 달성했다.
- terminal classification을 `P4_N4_PASS / 40 of 40 / failure_count=0`으로 전환했다.
- success-only FX Report, Acceptance JSON과 external machine artifacts 3개를 생성했다.
- r2/r3 `FAILED_PROTECTION` attempts는 historical evidence로 보존한다.
- P4-N4는 Closed이며 AIRE-G5/G6는 별도 승인 전까지 시작하지 않는다.

## v3.4 Changelog / Migration

- quiescent baseline 후보 아래 fresh r3 B/C/D registrations로 revised exact 40 전체를 재실행했다.
- r3에서도 Group A 8/8, B 16/16, C 8/8, D 7/8과 public predicate 39개 PASS를 동일하게 재현했다.
- r3 중 `Workspace/docs/plan/UEMCP_COV_Result.md` 한 파일이 baseline 이후 수정되어 D08 protection이 다시 실패했다.
- latest failure report SHA-256 `0d92fffada2476635c51752465d4ffc1d4d6bae12154ae2b3268377bea1acfb1`을 등록했다.
- r2 mismatch 8건은 historical attempt로 보존하고 current blocker를 r3 mismatch 1건으로 갱신했다.
- concurrent GoPyMCP document work가 종료된 quiescent window 전에는 추가 exact 40 재실행을 중단한다.

## v3.3 Changelog / Migration

- revised exact 40 v1.1을 fresh B/C/D registrations와 28 public calls로 실행했다.
- Group A 8/8, B 16/16, C 8/8, D 7/8로 총 39 PASS / 1 FAIL을 기록했다.
- public provider/query/context/dependency predicate 39개는 충족했고 Product·Transport·Consumer defect는 관측되지 않았다.
- calls 진행 중 이 세션 외부의 GoPyMCP COV/policy worktree 상태 8개가 추가되어 `P4N4-D08 protected mismatch 0`이 실패했다.
- terminal classification을 `FAILED_PROTECTION`으로 전환하고 success-only artifacts는 생성하지 않았다.
- 다음 실행은 concurrent GoPyMCP 작업 종료 후 new registrations와 new result refs로 exact 40 전체를 재실행한다.

## v3.2 Changelog / Migration

- 후속 runtime external provider registration과 Browser server-instance equality를 반영했다.
- authoritative P4-N3 report와 registered `Outputs\Deep`를 대조해 `MATCHED_PROVIDER_ROOT`를 확정했다.
- native selected asset 26 Entity / 38 Relation과 zero-instance Deep feature shape를 기록했다.
- original exact 40 v1.0을 `31 satisfiable / 9 unsatisfiable`로 감사하고 current 상태를 `BLOCKED_AUTHORIZATION_CONTRACT`로 교정했다.
- `AIResourceEvidencePhase4P4N4AuthorizationRevision.md` v1.0을 revised execution contract v1.1의 Current 진입점으로 등록했다.
- GoPyMCP Source/schema/config 변경 필요성을 false로 확정하고 revised exact 40은 아직 시작하지 않았다.
...
현재 AssetDump는 `ADUMP-v1.2.0-AIRE / Completed / Consumer Accepted / AIRE-G6 PASS` 상태다. Phase 5 successor remediation, current v0.24.2 release package의 Phase 2/1 regression과 real-project probe, post-correction public Consumer revalidation까지 완료됐다. Historical AIRE-G5는 `FAILED_REAL_PROJECT_EVIDENCE`로 그대로 보존하며 P4-N4와 r2/r3 failed-protection attempts도 완료 이력으로 유지한다.

### 현재 활성 계획

```text
active feature lifecycle: ADUMP-v1.2.0-AIRE / Completed / Consumer Accepted
active feature task: ADUMP-v1.2.0-AIRE-G6 / Completed / AIRE_G6_PASS
...
contract revision: Documents/Plan/AIResourceEvidencePhase4ContractRevision.md v1.2 / Accepted
...
P4-N2 Content result: Documents/Plan/AIREP4N2ContentResult.md v1.0 / P4_N2_CONTENT_PASS / Exact 17 Accepted
P4-N3 Authorization Review: Documents/Plan/AIResourceEvidencePhase4P4N3AuthorizationReview.md v1.1 / Authorization Exercised / Historical
...
P4-N3 Source Defect Authorization Review: Documents/Plan/AIResourceEvidencePhase4P4N3SourceDefectAuthorizationReview.md v1.0 / Authorization Exercised / Historical
...
completed phase: Phase 5 — Material Evidence Adapter / Completed / Accepted
completed phase: Phase 6 — Hardening and Release / Completed / Accepted
...
completed gate: P4-N0R — GO_REDUCED / failure_count=0 / 2026-08-05
completed gate: P4-N1 — P4_N1_PASS / failure_count=0 / 2026-08-05
completed gate: P4-N2 Source — P4_N2_SOURCE_PASS / failure_count=0 / 2026-08-06
completed gate: P4-N2 Content — P4_N2_CONTENT_PASS / Exact 17 Accepted / 2026-08-06
completed validation: P4-N3 — P4_N3_PASS / 60 PASS / 0 FAIL / blocked 0 / skipped 0 / failure_count=0 / 2026-08-07
P4-N4 fresh provider preparation: P4_N3_PASS / 60 of 60 / protection PASS / 2026-08-07
P4-N4 provider registration: PASS at verification time / active explicit / same server instance
...
current gate: AIRE-G6 PASS / AIRE_G6_PASS
current phase: Phase 6 Hardening and Release / Completed / Accepted
role gate: PASS / AssetDump feature candidate
AIRE-G0~G4: PASS
AIRE-G5: Exercised / FAILED_REAL_PROJECT_EVIDENCE / Historical / unchanged
AIRE-G6: PASS
...
- controlled Content baseline은 기존 exact 12에 P4-N2 Deep fixture exact five를 추가한 정확히 17개 binary files다. 기존 12의 path/length/SHA-256은 보존됐고 신규 5개 baseline은 `AIREP4N2ContentResult.md`가 소유한다.
...
- 2026-08-04 Phase 2 maintenance에서 comma-list CLI가 첫 항목에서 잘리던 `ADumpEntityQuery` 결함을 v1.3.1로 교정하고 fresh BuildPlugin과 canonical Phase 2 v1.18.13을 재통과했다. report SHA-256은 `0399beae972753c5cc0ac623f8a740ce74f7cfa3dfcd4d0e9aa24e94c5542852`이며 Entity Evidence, AIRE-G2, Niagara closure, Content invariance와 P2B가 모두 PASS다.
...
- GoPyMCP `ue.assetdump_evidence_safe` 구현, Browser exact 18 publication과 structured discover transport는 실제 확인됐다.
- 직전 managed smoke는 `class_filter=Blueprint`, `max_assets=1`, `rebuild_index=false`였으며 이 partial output에서 NiagaraSystem 0건과 `entity_index_v1` missing이 관측됐다.
- Phase 2 accepted Niagara fixture와 entity index/query/context evidence가 존재하므로 현재 현상을 Product Source 결함으로 단정하지 않는다.
- Provider Readiness PR0은 managed fingerprint `4bf4529a11a0699f8932929a6ec93bc13c53b765fcabf54f60f83cad7e0216ba`의 10-asset root가 partial/stale preparation이며 query-ready `entity_evidence_v1` 입력이 아님을 확인했다.
- PR1 job `7c5196d45b70435eb3a5611fbe3f2b3f`은 fresh Niagara evidence 380/599, asset/entity index와 filtered list query 3 Entity를 deterministic하게 PASS했다.
- provider report SHA-256은 `9888b7b0093613f0cc30ccd8e1b8a189d5155c75ab4e9279928fd21ad797681b`, closure summary SHA-256은 `ee1a590060f50f05be850e96c3e468b644ec25e9ed28e0edb35058d9fea4fefa`다.
- PR2는 `A. No product defect / preparation mismatch`, PR3 Product 변경 없음, PR4 Provider Ready로 완료됐다.
- GoPyMCP Browser actual full chain은 fresh source fingerprint `d86d4aad5dfc18e91dcf390245a05cbb345e519eaced2642543ec817ed42f584`, discover/list/get/expand/context/dependency PASS, native equality PASS, runtime canary PASS와 `failure_count=0`으로 AIRE-G3를 통과했다.
- AIRE-G4 process-local result_ref/cursor는 완료 증거이며 재사용하지 않는다. Phase 4 구현·검증은 새 task identity와 fresh fixture/provider를 사용한다.
...
- 완료 체크포인트: `P4-N2 Native Deep Evidence Source-only Closure`
- 최종 상태: `Completed / P4_N2_SOURCE_PASS / failure_count=0`
- 대표 Plan: `Documents/Plan/AIResourceEvidencePhase4Plan_v1.md` v1.11
- authoritative Source result: `Documents/Plan/AIREP4N2SourceResult.md` v1.0
- authoritative Content result: `Documents/Plan/AIREP4N2ContentResult.md` v1.0
- final process job: `08e5781c9a0e4a96938eec7a7eaab6c1`
- final report: `C:\Users\chaeksong\AppData\Local\Temp\AssetDumpP4N2SourceReports\p4_n2_source_report_20260806_045423_584_3f6a0e31.json`
- final report SHA-256: `c40f91b61365b71ac709878b0492b014803c147829b838343a1bf4122cb0c914`
- canonical Phase 2 SHA-256: `c457eefe06ab334c398beaba05c133dc80f7add9edd1d5b77f0fc0e3c097b2be`
- canonical Phase 1 Matrix SHA-256: `f659a2b9173026f53fa7ad4a6a83bf437993f886a87f903d0f18c80c6a30f5b0`
- Source closure 시 repository Content: exact 12 before/after / tracked write 0
- 후속 Content closure: exact five accepted / exact 17 / P4_N2_CONTENT_PASS
- 다음 사용자 결정: P4-N3/P4-N4 범위와 authorization 별도 검토
- 마지막 완결 공개 기능 계약은 계속 `ADUMP-v1.0.2-AICB Completed / Contract Accepted`다.

상세 Source closure와 runner finalization correction은 `AIREP4N2SourceResult.md` v1.0, tracked Content closure와 exact-five baseline은 `AIREP4N2ContentResult.md` v1.0을 따른다.
...
```text
lifecycle: ADUMP-v1.2.0-AIRE / Completed / Consumer Accepted / AIRE-G6 PASS
active_feature: ADUMP-v1.2.0-AIRE
completed_subtask: ADUMP-v1.2.0-AIRE-P4-N2-CONTENT / P4_N2_CONTENT_PASS
completed_source_subtask: ADUMP-v1.2.0-AIRE-P4-N2-SOURCE / P4_N2_SOURCE_PASS
...
completed_phase_3: Phase 3 — GoPyMCP Consumer Integration / Completed
completed_phase_5: Phase 5 — Material Evidence Adapter / Completed / Accepted
current_phase: Phase 6 — Hardening and Release / Completed / Accepted
...
completed_gate_PROVIDER_READY: PASS / Classification A / 2026-08-04
completed_gate_P3_P2B: PASS / Browser Actual Full Chain / 2026-08-05
completed_gate_AIRE_G3: PASS / failure_count=0 / 2026-08-05
completed_gate_AIRE_G4: PASS / 12 of 12 / failure_count=0 / 2026-08-05
completed_gate_P4_P0_PLANNING: PASS / 2026-08-05
completed_gate_P4_P0_CONTRACT_REVIEW: PASS / Accepted / 2026-08-05
completed_gate_P4_N0: NO_GO under frozen contract / 2026-08-05
completed_gate_P4_CR1: Accepted Revised Contract / 2026-08-05
completed_gate_P4_N0R: GO_REDUCED / failure_count=0 / 2026-08-05
completed_gate_P4_N1: PASS / P4_N1_PASS / failure_count=0 / 2026-08-05
completed_gate_P4_N2_SOURCE: PASS / P4_N2_SOURCE_PASS / failure_count=0 / 2026-08-06
completed_gate_P4_N2_CONTENT: PASS / P4_N2_CONTENT_PASS / failure_count=0 / Exact 17 Accepted / 2026-08-06
completed_validation_P4_N3: P4_N3_PASS / 60 of 60 / failure_count=0 / protection PASS / 2026-08-07
completed_review_P4_N3_SOURCE_DEFECT_AUTH: Authorization Exercised / Historical / 2026-08-06
P4_N4_original_authorization: Documents/Plan/AIResourceEvidencePhase4P4N4ControlledConsumerAuthorizationReview.md v1.0 / Exercised / Historical
P4_N4_authorization_revision: Documents/Plan/AIResourceEvidencePhase4P4N4AuthorizationRevision.md v1.0 / revised contract v1.1 / Exercised / Historical contract
P4_N4_result: Documents/Plan/AIREP4N4Result.md v1.4 / P4_N4_PASS / r4 40 PASS / 0 FAIL
P4_N4_fresh_preparation: P4_N3_PASS / 60 of 60 / protection PASS
P4_N4_provider_registration: PASS at verification time
P4_N4_provider_root: MATCHED_PROVIDER_ROOT
P4_N4_revised_exact_40: r2 39/40 Historical / r3 39/40 Historical / r4 40/40 Accepted
current_gate: AIRE-G6 PASS / AIRE_G6_PASS
representative_result: Documents/Plan/AIREG6Result.md v1.2
consumer_revalidation: Documents/Plan/AIREG6ConsumerReval.json / AIRE_G6_PUBLIC_CONSUMER_REVALIDATION_PASS / SHA-256 cbf4721418650530b6441c0a24f40b197f4ad39c1858d17f15e86031515d2720
phase4_representative_plan: Documents/Plan/AIResourceEvidencePhase4Plan_v1.md v1.20
contract_review: Documents/Plan/AIResourceEvidencePhase4ContractReview.md v1.9
contract_revision: Documents/Plan/AIResourceEvidencePhase4ContractRevision.md v1.2
authorization_review: Documents/Plan/AIResourceEvidencePhase4P4N1AuthorizationReview.md v1.1 / Authorization Exercised
P4_N1_result: Documents/Plan/AIREP4N1Result.md v1.0 / PASS
P4_N2_source_authorization: Documents/Plan/AIResourceEvidencePhase4P4N2SourceAuthorizationReview.md v1.1 / Authorization Exercised / Historical
P4_N2_source_result: Documents/Plan/AIREP4N2SourceResult.md v1.0 / P4_N2_SOURCE_PASS / failure_count=0
P4_N2_content_gate: Documents/Plan/AIResourceEvidencePhase4P4N2ContentAuthorizationGate.md v1.3 / Authorization Exercised / Historical
P4_N2_content_result: Documents/Plan/AIREP4N2ContentResult.md v1.0 / P4_N2_CONTENT_PASS / failure_count=0 / Exact 17 Accepted
P4_N3_authorization: Documents/Plan/AIResourceEvidencePhase4P4N3AuthorizationReview.md v1.1 / Authorization Exercised / Historical
P4_N3_result: Documents/Plan/AIREP4N3Result.md v2.0 / P4_N3_PASS / 60 of 60 / failure_count=0 / protection PASS
P4_N3_source_defect_authorization_review: Documents/Plan/AIResourceEvidencePhase4P4N3SourceDefectAuthorizationReview.md v1.0 / Authorization Exercised / Historical
P4_N0_result: Documents/Plan/AIResourceEvidencePhase4SpikeResult.md v1.1 / NO_GO
P4_N0R_result: Documents/Plan/AIREP4N0RResult.md v1.0 / GO_REDUCED
P4_N0R_report_sha256: e8a03870bd8b7ef05bcb76dcf99642079ffa192037857b02a40263115ec60ec2
P4_N0R_summary_sha256: 97339a1f0a7f2b76d0cde4ad23cf894aff7f9532e2caa31bf88cfc08e7a8114b
consumer_result: Documents/Plan/AIResourceEvidenceG4Result.md v1.0
provider_closure: Documents/Plan/AIREP3ProviderReady.md v1.1.0
...
AIRE_G3: PASS / Browser full chain / native equality / runtime canary / failure_count=0
AIRE_G4: PASS / Golden Consumer Journey / reports / no manual file access
implementation_authorization: G6 release correction and validation exercised and closed; no additional Product/Script/Content/Config work is authorized by this closure
implementation_state: v0.24.2 ordering correction / final Phase2 PASS / Phase1 Matrix PASS / fresh real-project PASS / fresh public Consumer revalidation PASS / exact 17 protected
next_decision: AIRE release lifecycle closed; future feature work requires a new explicit lifecycle and Plan
...
last_accepted_checkpoint: ADUMP-v1.2.0-AIRE-P3-G4 / Consumer Workflow Accepted
...
first_product_vertical_slice: Niagara FX Evidence / Browser Consumer Accepted
...
PowerShell_5_1_self_tests: PASS / Phase 2 v1.18.13 and Phase 1 Matrix v1.4
BuildPlugin: PASS / fresh compile and package
canonical_Phase_2: PASS / v1.18.13 / failure_count=0 / maintenance re-accepted
canonical_Phase_2_report_sha256: 0399beae972753c5cc0ac623f8a740ce74f7cfa3dfcd4d0e9aa24e94c5542852
...
Consumer_Integration: Completed / AIRE-G3+G4 PASS / Browser Consumer Accepted / failure_count=0
```
...
closure report: Documents/Plan/AssetIntelligencePlan/v1_0_2_AIContextBundleClose_v1.md
next_candidate: new request identity + fresh managed provider registration + discover/entity_query/entity_context/dependency_query actual chain
```
...
- GoPyMCP Browser actual discover/list/get/expand/entity_context/dependency_query full chain과 multi-kind transport를 PASS로 반영했다.
- native stable-field equality, endpoint closure, bounds·fingerprint·provenance, runtime canary와 actual Consumer `failure_count=0`을 근거로 AIRE-G3를 PASS로 전환했다.
- current gate를 P3-P4 AIRE-G4 Golden Consumer Journey로 이동했다.
- AssetDump Source·tracked Scripts·Content와 accepted schema 추가 변경은 없었다.

### v1.93 - 2026-08-04

- Provider Readiness PR0~PR4 actual closure와 Classification A 판정을 반영했다.
- current managed 10-asset root의 partial preparation과 AssetDump Product defect를 분리했다.
- isolated fresh Niagara evidence/index/query, repeat determinism과 source/host 12-file Content invariance PASS를 기록했다.
- `ADUMP-v1.2.0-AIRE-P3-PR`을 Completed / Provider Ready로 닫고 current gate를 GoPyMCP actual Consumer validation으로 전환했다.
- AIRE-G3는 Provider Ready만으로 PASS 처리하지 않고 full public chain 전까지 Partial Actual / Not Accepted로 유지했다.

### v1.92 - 2026-08-04

- `EntityKinds`, `RelationKinds`, `Facets` comma-list가 첫 항목에서 잘리던 provider CLI 결함을 `ADumpEntityQuery.cpp` v1.3.1로 교정한 maintenance closure를 기록했다.
- fresh BuildPlugin과 canonical Phase 2 v1.18.13에서 filtered relation coverage, endpoint closure, Entity Evidence, AIRE-G2, Niagara, Content invariance와 P2B 전체 PASS를 반영했다.
- provider readiness의 NiagaraSystem 0건/entity index missing 조사와 이번 comma-list parser 결함을 별개 원인으로 유지했다.
- 현재 활성 작업 `ADUMP-v1.2.0-AIRE-P3-PR`과 AIRE-G3/G4 상태는 변경하지 않았다.

### v1.91 - 2026-08-03

- GoPyMCP facade 구현·Browser 18 publication·discover transport PASS와 AssetDump provider dataset blocker를 현재 상태에 반영했다.
- 직전 Blueprint-only one-asset no-rebuild smoke를 Product Source defect 증거로 사용하지 않도록 교정했다.
- `ADUMP-v1.2.0-AIRE-P3-PR`과 `Documents/Plan/AIREP3ProviderReady.md`를 현재 AssetDump 작업으로 등록했다.
- PR0 read-only baseline, PR1 isolated preparation과 PR2 원인 분류 전에는 Source·Scripts·Content 수정을 금지했다.
...
### v1.94 AIRE-G3 acceptance 및 AIRE-G4 이관 안내

- AIRE-G3는 GoPyMCP Browser actual full chain, native equality, runtime canary와 `failure_count=0`으로 PASS다.
- AIRE-G3 재검증이 목적이 아닌 다음 세션은 P3-P4 AIRE-G4 Golden Consumer Journey에서 시작한다.
- process-local result_ref/cursor는 세션 간 재사용하지 않고 새 `client_request_id`와 fresh discover부터 실행한다.
- AIRE-G4는 공개 GoPyMCP 도구만 사용하며 로컬 dump/index 파일 직접 접근, `repo.read_batch` 우회와 수동 JSON 복사를 금지한다.
- AssetDump Product Source·tracked Scripts·Content와 accepted schema는 AIRE-G4를 위해 변경하지 않는다.

### v1.93 Provider Ready handoff 안내

- `ADUMP-v1.2.0-AIRE-P3-PR`은 Completed / Provider Ready / Classification A다.
- Current 실행 진입점은 `Documents/Plan/AIResourceEvidencePhase3Plan_v1.md`이며 Provider Plan은 closure 증거다.
- GoPyMCP actual validation은 새 request identity와 fresh managed provider registration을 사용한다.
- managed fingerprint `4bf4529a...`의 10-asset root와 이전 result_ref/cursor는 재사용하지 않는다.
- AssetDump Product Source, tracked Scripts, Content와 accepted schema는 추가 변경하지 않는다.

### v1.91 Provider Readiness 이관 안내

- 다음 AssetDump 세션은 `Documents/Plan/AIREP3ProviderReady.md`에서 시작한다.
- GoPyMCP facade와 Browser publication은 완료 증거로 보존하며 AssetDump 저장소에서 다시 구현하지 않는다.
- 직전 Blueprint-only partial managed output을 Phase 2 accepted Niagara baseline의 실패로 해석하지 않는다.
- fresh Niagara `asset_index_v1`, valid `entity_index_v1`과 `entityquery list` positive를 확보한 뒤 GoPyMCP actual Consumer chain으로 돌려보낸다.
- PR2에서 실제 결함 범주가 확정되기 전에는 Source·Scripts·Content exact allowlist를 열지 않는다.
